...
TASKS=[
   ...
   "validation"  : [{"validationquery": [""],
            ...
            "correctanswer":["true","false","error","error"],
            "speakbblanswer":["Super! Du hast verstanden wie das Formular funktioniert. <br> <br> <br> <br>","Schade, das hat leider nicht geklappt. Versuche erneut nach dem letzten Slash '?product_id=0' einzugeben. <br> <br> <br> <br>"],
            "imganswer":["img/happybee.png","img/surprisebee.png"],
            "whitelist": ["shoes"],
            "blacklist": ["maxmustermann","alexamusterfrau"]}],
   "form":"url",
   ...
   "validation"  : [{"validationquery": [""],
            ...
            "truecondition":"results.rows.length == 1",
            "correctanswer":["true","false","error","error"],
            "speakbblanswer":["Super! du hast die Herausforderung gemeistert! <br> <br> <br> <br>","Schade, das hat leider nicht geklappt. Versuche erneut etwas über einen Mitarbeiter herauszufinden. <br> Zur Erinnerung: Die Tabelle hat folgende Spaltennamen: 'ma_id', 'name','vorname','email','lohn' & 'angestellt_seit'."],
            "imganswer":["img/happybee.png","img/surprisebee.png"],
   ...
   "validation"  : [{"validationquery": [""],
            ...
            "correctanswer":["true","false","error","error"],
            "speakbblanswer":["Super! du hast die Herausforderung gemeistert! <br> <br> <br> <br>","Schade, das hat leider nicht geklappt. Versuche erneut die Tabellennamen der Kundentabelle auszugeben.  <br> Zur Erinnerung: Die vordefinierte Tabelle mit den Spaltennamen hieß sys.user_tab_columns."],
            "imganswer":["img/happybee.png","img/surprisebee.png"],
            "whitelist": [""],
            "blacklist": ["maxmustermann","alexamusterfrau",";"]}],
   "form":"search",
   ...
   "validation"  : [{"validationquery": [""],
            ...
            "correctanswer":["true","false","error","error"],
            "speakbblanswer":["Super! du hast die Herausforderung gemeistert! <br> <br> <br> <br>","Schade, das hat leider nicht geklappt. Versuche erneut die Kundentabelle auszugeben. <br> Zur Erinnerung: Die Kundentabelle besitzt die Spalten 'kunden_id','name','email','bestellnr' & 'adresse'."],
            "imganswer":["img/happybee.png","img/surprisebee.png"],
            "whitelist": [""],
            "blacklist": ["maxmustermann","alexamusterfrau",";"]}],
   "form":"search",
